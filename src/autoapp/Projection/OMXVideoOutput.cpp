...
Q_LOGGING_CATEGORY(lcOMXVideoOut, "journeyos.video.output.omx")
...
namespace f1x::openauto::autoapp::projection {
    ...
    bool OMXVideoOutput::open()
    {
        ...
        qDebug(lcOMXVideoOut) << "[OMXVideoOutput] open.";

        bcm_host_init();
        if(OMX_Init() != OMX_ErrorNone)
        {
            qCritical(lcOMXVideoOut) << "[OMXVideoOutput] omx init failed.";
            return false;
        }
        ...
        if(client_ == nullptr)
        {
            qCritical(lcOMXVideoOut) << "[OMXVideoOutput] ilclient init failed.";
            return false;
        }
        ...
        {
            qCritical(lcOMXVideoOut) << "[OMXVideoOutput] setup tunnels failed.";
            return false;
        }
        ...
        {
            qCritical(lcOMXVideoOut) << "[OMXVideoOutput] enable port buffers failed.";
            return false;
        }
    ...
    bool OMXVideoOutput::init()
    {
        ...
        qDebug(lcOMXVideoOut) << "[OMXVideoOutput] init, state: " << isActive_;
    ...
    {
        qDebug(lcOMXVideoOut) << "[OMXVideoOutput] stop.";
    ...
    bool OMXVideoOutput::createComponents()
    {
        ...
        {
            qCritical(lcOMXVideoOut) << "[OMXVideoOutput] video decode component creation failed.";
            return false;
        }
        ...
        {
            qCritical(lcOMXVideoOut) << "[OMXVideoOutput] video renderer component creation failed.";
            return false;
        }

        if(ilclient_create_component(client_, &components_[VideoComponent::CLOCK], const_cast<char*>("clock"), ILCLIENT_DISABLE_ALL_PORTS) != 0)
        {
            qCritical(lcOMXVideoOut) << "[OMXVideoOutput] clock component creation failed.";
            return false;
        }

        if(!this->initClock())
        {
            qCritical(lcOMXVideoOut) << "[OMXVideoOutput] clock init failed.";
            return false;
        }
        ...
        {
            qCritical(lcOMXVideoOut) << "[OMXVideoOutput] video scheduler component creation failed.";
            return false;
        }
