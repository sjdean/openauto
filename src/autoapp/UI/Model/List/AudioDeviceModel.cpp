#include "f1x/openauto/autoapp/UI/Model/List/AudioDeviceModel.hpp" // Renamed

#include "f1x/openauto/autoapp/UI/Model/List/AudioDeviceDirection.hpp"
#include <qloggingcategory.h>
Q_LOGGING_CATEGORY(lcComboAudio, "journeyos.audio.device.list")
namespace f1x::openauto::autoapp::UI::Model::List {

  // Updated constructor
  AudioDeviceModel::AudioDeviceModel(std::shared_ptr<Backend::Audio::IAudioHandler> audioHandler,
