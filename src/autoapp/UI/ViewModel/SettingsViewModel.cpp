...
namespace f1x::openauto::autoapp::UI::ViewModel {
  SettingsViewModel::SettingsViewModel(configuration::IConfiguration::Pointer configuration,
      ...
      m_carId(configuration_->getSettingByName<QString>("Car", "Id")),
      ...
      m_wirelessHotspotInterface(configuration_->getSettingByName<QString>("Wireless", "Interface")),
      m_wirelessType(configuration_->getSettingByName<common::Enum::WirelessType::Value>("Wireless", "Type")),
