...
ServiceList ServiceFactory::create(aasdk::messenger::IMessenger::Pointer messenger, aasdk::messenger::IMessenger::Pointer videoMessenger, service::ICarConnect::Pointer carconnect)
{
    ...
    serviceList.emplace_back(std::make_shared<SensorService>(ioService_, messenger, carconnect));
    serviceList.emplace_back(this->createVideoService(videoMessenger));
